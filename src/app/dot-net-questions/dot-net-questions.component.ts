...
@Component({
  selector: 'app-dot-net-questions',
  templateUrl: './dot-net-questions.component.html',
  styleUrls: ['./dot-net-questions.component.css']
})
export class DotNetQuestionsComponent implements OnInit {
