...
@Component({
  selector: 'app-advance-java-questions',
  templateUrl: './advance-java-questions.component.html',
  styleUrls: ['./advance-java-questions.component.css']
})
export class AdvanceJavaQuestionsComponent implements OnInit {
