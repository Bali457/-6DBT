...
@Component({
  selector: 'app-database-technology-questions',
  templateUrl: './database-technology-questions.component.html',
  styleUrls: ['./database-technology-questions.component.css']
})
export class DatabaseTechnologyQuestionsComponent implements OnInit {
