...
@Component({
  selector: 'app-mean-stack-questions',
  templateUrl: './mean-stack-questions.component.html',
  styleUrls: ['./mean-stack-questions.component.css']
})
export class MeanStackQuestionsComponent implements OnInit {
