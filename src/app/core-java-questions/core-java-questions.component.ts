...
@Component({
  selector: 'app-core-java-questions',
  templateUrl: './core-java-questions.component.html',
  styleUrls: ['./core-java-questions.component.css']
})
export class CoreJavaQuestionsComponent implements OnInit {
