...
@Component({
  selector: 'app-software-engineering-questions',
  templateUrl: './software-engineering-questions.component.html',
  styleUrls: ['./software-engineering-questions.component.css']
})
export class SoftwareEngineeringQuestionsComponent implements OnInit {
