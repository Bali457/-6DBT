...
@Component({
  selector: 'app-advanced-web-programming-questions',
  templateUrl: './advanced-web-programming-questions.component.html',
  styleUrls: ['./advanced-web-programming-questions.component.css']
})
export class AdvancedWebProgrammingQuestionsComponent implements OnInit {
