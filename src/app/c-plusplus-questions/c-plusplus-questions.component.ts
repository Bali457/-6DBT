...
@Component({
  selector: 'app-c-plusplus-questions',
  templateUrl: './c-plusplus-questions.component.html',
  styleUrls: ['./c-plusplus-questions.component.css']
})
export class CPlusplusQuestionsComponent implements OnInit {
